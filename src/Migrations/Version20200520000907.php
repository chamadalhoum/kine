 ...
 */
final class Version20200520000907 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE dossiermedicale (id INT AUTO_INCREMENT NOT NULL, patient_id INT DEFAULT NULL, medicaux VARCHAR(255) NOT NULL, chirurgie VARCHAR(255) NOT NULL, allergie VARCHAR(255) NOT NULL, document VARCHAR(255) NOT NULL, analyse VARCHAR(255) NOT NULL, radio VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_520111F26B899279 (patient_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE dossiermedicale ADD CONSTRAINT FK_520111F26B899279 FOREIGN KEY (patient_id) REFERENCES patient (id)');
