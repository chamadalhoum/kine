 ...
 */
final class Version20200520045932 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE dossiermedicale ADD document_id INT DEFAULT NULL, ADD analyse_id INT DEFAULT NULL, ADD photos_id INT DEFAULT NULL, DROP document, DROP analyse, DROP photos, CHANGE patient_id patient_id INT DEFAULT NULL, CHANGE chirurgie chirurgie VARCHAR(255) DEFAULT NULL, CHANGE allergie allergie VARCHAR(255) DEFAULT NULL, CHANGE radio radio VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE dossiermedicale ADD CONSTRAINT FK_520111F2C33F7837 FOREIGN KEY (document_id) REFERENCES document (id)');
        $this->addSql('ALTER TABLE dossiermedicale ADD CONSTRAINT FK_520111F21EFE06BF FOREIGN KEY (analyse_id) REFERENCES analyse (id)');
        $this->addSql('ALTER TABLE dossiermedicale ADD CONSTRAINT FK_520111F2301EC62 FOREIGN KEY (photos_id) REFERENCES photos (id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_520111F2C33F7837 ON dossiermedicale (document_id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_520111F21EFE06BF ON dossiermedicale (analyse_id)');
        ...
        $this->addSql('ALTER TABLE photos CHANGE photos photos VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE dossiermedicale DROP FOREIGN KEY FK_520111F2C33F7837');
        $this->addSql('ALTER TABLE dossiermedicale DROP FOREIGN KEY FK_520111F21EFE06BF');
        $this->addSql('ALTER TABLE dossiermedicale DROP FOREIGN KEY FK_520111F2301EC62');
        $this->addSql('DROP INDEX UNIQ_520111F2C33F7837 ON dossiermedicale');
        $this->addSql('DROP INDEX UNIQ_520111F21EFE06BF ON dossiermedicale');
        $this->addSql('DROP INDEX UNIQ_520111F2301EC62 ON dossiermedicale');
        $this->addSql('ALTER TABLE dossiermedicale ADD document VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, ADD analyse VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, ADD photos VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, DROP document_id, DROP analyse_id, DROP photos_id, CHANGE patient_id patient_id INT DEFAULT NULL, CHANGE chirurgie chirurgie VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE allergie allergie VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE radio radio VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('ALTER TABLE employe CHANGE employe_id employe_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE photos CHANGE photos photos VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
