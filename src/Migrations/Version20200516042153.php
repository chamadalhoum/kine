 ...
 */
final class Version20200516042153 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE produit CHANGE tva tva INT DEFAULT NULL, CHANGE prix_ttc prix_ttc DOUBLE PRECISION DEFAULT \'NULL\', CHANGE quantite quantite INT DEFAULT NULL');
        $this->addSql('ALTER TABLE rendezvous CHANGE date date DATE DEFAULT \'NULL\', CHANGE heure heure DATETIME DEFAULT \'NULL\', CHANGE duree duree TIME DEFAULT \'NULL\'');
