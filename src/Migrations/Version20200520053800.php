 ...
 */
final class Version20200520053800 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_876E0D9301EC62 ON photos');
        $this->addSql('ALTER TABLE photos CHANGE name name VARCHAR(255) DEFAULT NULL, CHANGE photos_id dossiermedicale_id INT NOT NULL');
        $this->addSql('ALTER TABLE photos ADD CONSTRAINT FK_876E0D9F4DF715A FOREIGN KEY (dossiermedicale_id) REFERENCES dossiermedicale (id)');
        $this->addSql('CREATE INDEX IDX_876E0D9F4DF715A ON photos (dossiermedicale_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE photos DROP FOREIGN KEY FK_876E0D9F4DF715A');
        $this->addSql('DROP INDEX IDX_876E0D9F4DF715A ON photos');
        $this->addSql('ALTER TABLE photos CHANGE name name VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE dossiermedicale_id photos_id INT NOT NULL');
        $this->addSql('ALTER TABLE photos ADD CONSTRAINT FK_876E0D9301EC62 FOREIGN KEY (photos_id) REFERENCES dossiermedicale (id)');
        $this->addSql('CREATE INDEX IDX_876E0D9301EC62 ON photos (photos_id)');
