 ...
 */
final class Version20200520002828 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE dossiermedicale ADD photos VARCHAR(255) NOT NULL, CHANGE patient_id patient_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE depense CHANGE date date DATETIME DEFAULT \'NULL\', CHANGE id_cabinet id_cabinet INT DEFAULT NULL');
        $this->addSql('ALTER TABLE dossiermedicale DROP photos, CHANGE patient_id patient_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE employe CHANGE employe_id employe_id INT DEFAULT NULL');
