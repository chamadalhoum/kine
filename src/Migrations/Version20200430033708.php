 ...
 */
final class Version20200430033708 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE cabinet (id INT AUTO_INCREMENT NOT NULL, centre VARCHAR(255) NOT NULL, adresse VARCHAR(255) NOT NULL, fixe VARCHAR(255) NOT NULL, portable VARCHAR(255) NOT NULL, mail_directeur VARCHAR(255) NOT NULL, page_facebook VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
