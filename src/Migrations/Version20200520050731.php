 ...
 */
final class Version20200520050731 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE photos ADD name VARCHAR(255) DEFAULT NULL, DROP photos');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE photos ADD photos VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, DROP name');
