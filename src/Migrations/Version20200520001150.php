 ...
 */
final class Version20200520001150 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE suivi (id INT AUTO_INCREMENT NOT NULL, dossiermedical_id INT DEFAULT NULL, suivi VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_2EBCCA8FDAFFF6DA (dossiermedical_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE suivi ADD CONSTRAINT FK_2EBCCA8FDAFFF6DA FOREIGN KEY (dossiermedical_id) REFERENCES dossiermedicale (id)');
