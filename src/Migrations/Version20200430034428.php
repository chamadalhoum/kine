 ...
 */
final class Version20200430034428 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE produit (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, prix_unitaire DOUBLE PRECISION NOT NULL, tva INT DEFAULT NULL, prix_ttc DOUBLE PRECISION DEFAULT NULL, quantite INT DEFAULT NULL, id_salle INT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
